...
const Product = () => {
    ...
    const [size, setSize] = useState("");
    const [loading, setLoading] = useState(true);
    const [btnLoading, setBtnLoading] = useState(false); // ⬅️ زر التحميل
            ...
            <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
                ...
                <div className="flex-1">
                    ...
                    <button
                        ...
                        disabled={btnLoading}
                        className="bg-black text-white px-8 py-3 text-sm active:bg-gray-700 flex items-center justify-center"
                    >
                        {btnLoading ? (
